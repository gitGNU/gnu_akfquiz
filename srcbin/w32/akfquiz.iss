...
de.createquiz=&mkquiz: HTML-Datei für JavaScript erneuern
...
de.addon=zusätzliche Funktionen
en.langdoc=english
de.langdoc=deutsch
en.license=License
...
de.quizupload=Quiz-Datei veröffentlichen
en.sdldownload=download the needed SDL 1.2.x "Runtime library" for "Win32"
de.sdldownload=benötigte SDL 1.2.x "Runtime library" für "Win32" herunterladen
...
Name: "{group}\{cm:doc}\Lizenz (Übersetzung)"; Filename: "{app}\doc\deutsch\gpl-ger.html"; Languages: de
